<template id="EditCredit" v-loading="offer != undefined">
    <el-dialog class="credit-container2 add-offre" style="margin-top: -2rem; padding-top: 0rem; top: 0;background: rgba(255, 255, 255, .99);" :visible="show" :fullscreen="true" :width="(isMobile())?'100vw':'70vw'" @close="handleClose()">
                <el-row v-if="show" style="margin-top: -2rem;">
                    ...
                    <div style="text-align: right; float: right; width: 70%;">
                        <el-select placeholder="Choisir une banque" filterable class="select-bank" v-model="offer.bank" value-key="label">
                        ...
                        <el-input onClick="this.select()" class="select-name" v-model="offer.agence" :maxlength="15" type="text" placeholder="Nom de l'agence"></el-input>
                    </div>
                    <el-tabs type="card" v-model="offerDialog.pane" ref="tabs" @tab-remove="handleTabsRemove">
                        <el-tab-pane name="1" v-if="offer.money._is">
                            ...
                            <el-row :gutter="120">
                                <el-col :xs="{offset: 0, span: 23}" :sm="{offset: 0, span: 23}" :md="{ offset: 0, span: 23}" :lg="{ offset: 0, span: 12}" :xl="{ offset: 0, span: 12}">
                                    <div class="label-input">
                                        ...
                                        <el-input onkeypress="return event.charCode >= 48 && event.charCode <= 57" onClick="this.select()" v-model="offer.money.montantEmprunte" type="text">
                                    ...
                                    <div class="label-input">
                                        ...
                                        <el-input onkeypress="return event.charCode >= 48 && event.charCode <= 57" onClick="this.select()" v-model="offer.money.tauxCredit" type="text">
                                            <template slot="append">%</template>
                                        </el-input>
                                    </div>
                                    ...
                                    <div class="label-input">
                                        <label class="label">Durée</label>
                                         ...
                                         <el-input onkeypress="return event.charCode >= 48 && event.charCode <= 57" onClick="this.select()" v-model="offer.money.duree" type="text">
                                    ...
                                    <el-input onkeypress="return event.charCode >= 48 && event.charCode <= 57" onClick="this.select()" v-model="offer.money.mensualiteMois" type="text">
                                        <template slot="append">€/mois</template>
                                    </el-input>
                                </div>
                                    ...
                                    <div class="label-input">
                                        ...
                                        <el-input onkeypress="return event.charCode >= 48 && event.charCode <= 57" onClick="this.select()" v-model="offer.money.coutInteret" type="text">
                                            <template slot="append">€</template>
                                        </el-input>
                                    </div>
                                    ...
                                    <div class="label-input">
                                        ...
                                        <el-button v-tooltip="'Somme totale des intérêts à payer.'" class="help new-offer" @click="onboardDialog = true">?</el-button>
                                        <el-input onkeypress="return event.charCode >= 48 && event.charCode <= 57" onClick="this.select()" v-model="offer.money.fraisDossier" type="text">
                                            <template slot="append">€</template>
                                        </el-input>
                                    </div>
                                    ...
                                    <div class="label-input">
                                        ...
                                        <el-input onkeypress="return event.charCode >= 48 && event.charCode <= 57" onClick="this.select()" v-model="offer.money.coutGarantie" type="text">
                                            <template slot="append">€</template>
                                        </el-input>
                                    </div>

                                    <div class="label-input">
                                        <label class="label">Montant à rembours</label>
                                        ...
                                        <el-input onkeypress="return event.charCode >= 48 && event.charCode <= 57" onClick="this.select()" v-model="offer.money.montantRembourse" type="text">
                                            <template slot="append">€</template>
                                        </el-input>
                                    </div>
                                </el-col>
                            ...
                            <el-row style="margin-top: 3rem;margin-bottom: 2rem;" type="flex">
                            ...
                            <el-row type="flex">
                                <el-col :span="10" style="margin: 0 auto;">
                                    <el-button class="custom-btn" @click="saveChanges">Enregistrer les modifications</el-button>
                                </el-col>
                            </el-row>
                        </el-tab-pane>
                        ...
                        <el-tab-pane name="2" v-if="offer.assurance._is" :closable="offer.money._is">
                            ...
                            <el-row :gutter="64">
                                <el-col :xs="{offset: 0, span: 23}" :sm="{offset: 0, span: 23}" :md="{ offset: 0, span: 23}" :lg="{ offset: 0, span: 11}" :xl="{ offset: 0, span: 11}">
                                    <div class="label-input">
                                       ...
                                       <el-button v-tooltip="'Ou quotité d’assurance, correspond à la répartition de la couverture proposée par l’assureur entre les emprunteurs.'" class="help new-offer" @click="onboardDialog = true">?</el-button>
                                        <el-input onkeypress="return event.charCode >= 48 && event.charCode <= 57" onClick="this.select()" v-model="offer.assurance.tauxCouverture" type="text">
                                            <template slot="append">%</template>
                                        </el-input>
                                    </div>
                                ...
                                <el-col :xs="{offset: 0, span: 23}" :sm="{offset: 0, span: 23}" :md="{ offset: 0, span: 23}" :lg="{ offset: 0, span: 11}" :xl="{ offset: 0, span: 11}">
                                    <div class="label-input">
                                        ...
                                        <el-input onkeypress="return event.charCode >= 48 && event.charCode <= 57" onClick="this.select()" v-model="offer.assurance.tauxAssurance" type="text">
                                            <template slot="append">%</template>
                                        </el-input>
                                    </div>

                                    <div class="label-input">
                                        <label onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="label">Mensualité de l’assurance</label>
                                    ...
                                    <div class="label-input">
                                        <label onkeypress="return event.charCode >= 48 && event.charCode <= 57" class="label">Coût de l’assurance</label>
                            ...
                            <el-row type="flex">
                                <el-col :span="10" style="margin: 2rem auto;">
                                    <el-button @click="saveChanges">Enregistrer l'offre</el-button>
                                </el-col>
                            </el-row>
                        </el-tab-pane>
                    </el-tabs>
