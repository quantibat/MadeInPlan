<template id="signup">
    <div class="footer">
        ...
        <div ref="fileform" class="plan-upload-container" @click="openFileDialog('imageUpload')">
            <img class="plan-upload-item" src="/Assets/files-accepted.png">
            <i class="plan-upload-item budicon budicon-plus-ui"></i>
            <span class="plan-upload-item plan-upload-maintext">
                <span>Glissez et déposer vos fichiers</span>
            </span>
        </div>
    </div>
</template>
