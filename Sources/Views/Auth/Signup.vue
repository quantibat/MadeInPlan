        ...
        <el-row class="container" type="flex">
            ...
            <el-row type="flex" align="middle" class="form">
                ...
                <el-row class="social-login">
                    ...
                    <router-link class="button email-button" :to="{ name: 'Signup2'}">
                        <el-row type="flex" align="middle">
                            <i class="budicon budicon-email"></i>
...
.container { flex-direction: column; align-items: center; border-radius: 6px; background: #FFFFFF;padding: 1.5rem 5rem 4rem; box-shadow: 0 4px 22px 0px rgba(0, 0, 0, .09); }

.logo { height: 4rem; width: auto; margin-bottom: 0px; margin-top: 40px; }
.title { margin-bottom: 4rem; font-size: 1.6rem; color: #9196AB; font-weight: 300; width:60%; text-align: center; }
/* .form { width: 100%; } */

.social-login {display: flex; flex-direction: column;  }

.social-login .button {font-size: 1.1rem; width: 380px;  margin: .5rem auto; padding: 15px 0px; border-radius: 4px; text-align: center; }
...
@media only screen and (min-width: 500px) and (max-width: 1188px) {
   ...
   .container {
    ...
    .logo { height: 3rem; width: auto; margin-bottom: 0px; margin-top: 40px; }
    .title {
        font-size: 1.2em; line-height: 1.5; margin-bottom: 1rem;
    }
  .form {
      flex-direction: column;
      margin-bottom: rem;
...
.social-login .button {font-size: 1rem; width: 300px;  margin: .5rem auto; padding: 10px 0px; border-radius: 4px; text-align: center; }
